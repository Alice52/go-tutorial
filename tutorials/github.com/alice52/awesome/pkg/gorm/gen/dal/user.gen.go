...
import (
	...
	"github.com/alice52/awesome/pkg/gorm/gen/model"
)
...
type IUserDo interface {
	...
	SimpleFindByNameAndAge(name string, age int) (result model.User, err error)
	FindUserToMap(id int) (result map[string]interface{}, err error)
	InsertValue(age int, name string) (err error)
	FindNameById(id int) (result string)
	FindByIDOrCustom(cond bool, id int, key string, value string) (result []model.User, err error)
	UpdateName(name string, id int) (rowsAffected int64, err error)
}

// Where("name=@name and age=@age")
func (u userDo) SimpleFindByNameAndAge(name string, age int) (result model.User, err error) {
...
func (u userDo) FindUserToMap(id int) (result map[string]interface{}, err error) {
	var params []interface{}
...
func (u userDo) InsertValue(age int, name string) (err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	params = append(params, age)
	generateSQL.WriteString("insert into user (name,age) values (?,?) ")
...
func (u userDo) FindNameById(id int) (result string) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("select name from user where id=? ")
...
//
// {{end}}
func (u userDo) FindByIDOrCustom(cond bool, id int, key string, value string) (result []model.User, err error) {
	var params []interface{}
	...
	if key != "" && value != "" {
		...
		whereSQL0.WriteString("or " + u.Quote(key) + "=? ")
	}
...
//
// {{end}}
func (u userDo) UpdateName(name string, id int) (rowsAffected int64, err error) {
	var params []interface{}
